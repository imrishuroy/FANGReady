...
export const questions: Question[] = [
  ...
  { id: 'as-2', name: '3Sum', url: 'https://leetcode.com/problems/3sum', difficulty: 'Medium', pattern: 'Two Pointers', companies: ['Google', 'Amazon', 'Apple', 'Meta', 'Tesla'], frequency: '🔥🔥🔥', category: 'Two Pointers' },
  ...
  { id: 'as-8', name: 'Valid Palindrome', url: 'https://leetcode.com/problems/valid-palindrome', difficulty: 'Easy', pattern: 'Two Pointers', companies: ['Meta', 'Amazon'], frequency: '🔥🔥', category: 'Two Pointers' },
  { id: 'as-9', name: 'Valid Palindrome II', url: 'https://leetcode.com/problems/valid-palindrome-ii', difficulty: 'Easy', pattern: 'Two Pointers', companies: ['Meta'], frequency: '🔥🔥', category: 'Two Pointers' },
  { id: 'as-10', name: 'Move Zeroes', url: 'https://leetcode.com/problems/move-zeroes', difficulty: 'Easy', pattern: 'Two Pointers', companies: ['Meta'], frequency: '🔥🔥', category: 'Two Pointers' },
  ...
  { id: 'as-13', name: 'String Compression', url: 'https://leetcode.com/problems/string-compression', difficulty: 'Medium', pattern: 'Two Pointers', companies: ['Google'], frequency: '🔥', category: 'Two Pointers' },
  ...
  { id: 'as-18', name: 'Merge Strings Alternately', url: 'https://leetcode.com/problems/merge-strings-alternately', difficulty: 'Easy', pattern: 'Two Pointers', companies: ['Google'], frequency: '🔥', category: 'Two Pointers' },
  ...
  { id: 'as-21', name: 'Trapping Rain Water', url: 'https://leetcode.com/problems/trapping-rain-water', difficulty: 'Hard', pattern: 'Two Pointers/Stack', companies: ['Google', 'Amazon', 'Apple', 'Netflix', 'Palantir', 'Databricks'], frequency: '🔥🔥🔥', category: 'Two Pointers' },
  ...
  { id: 'as-29', name: 'Reverse Vowels of a String', url: 'https://leetcode.com/problems/reverse-vowels-of-a-string', difficulty: 'Easy', pattern: 'Two Pointers', companies: ['Google'], frequency: '🔥', category: 'Two Pointers' },
  ...
  // Design (18 questions)
  // ========================================
  { id: 'de-1', name: 'LRU Cache', url: 'https://leetcode.com/problems/lru-cache', difficulty: 'Medium', pattern: 'Hash + DLL', companies: ['Google', 'Amazon', 'Meta', 'Apple', 'Microsoft', 'Netflix', 'OpenAI', 'Palantir', 'Tesla', 'Databricks', 'LinkedIn', 'Anthropic'], frequency: '🔥🔥🔥', category: 'Design' },
  { id: 'de-2', name: 'LFU Cache', url: 'https://leetcode.com/problems/lfu-cache', difficulty: 'Hard', pattern: 'Hash + DLL', companies: ['Amazon', 'OpenAI', 'Google'], frequency: '🔥🔥', category: 'Design' },
  { id: 'de-3', name: 'Insert Delete GetRandom O(1)', url: 'https://leetcode.com/problems/insert-delete-getrandom-o1', difficulty: 'Medium', pattern: 'Hash + Array', companies: ['Amazon', 'LinkedIn'], frequency: '🔥🔥', category: 'Design' },
  { id: 'de-4', name: 'Design Hit Counter', url: 'https://leetcode.com/problems/design-hit-counter', difficulty: 'Medium', pattern: 'Queue/Array', companies: ['Netflix', 'Databricks', 'Anthropic'], frequency: '🔥🔥', category: 'Design' },
  { id: 'de-5', name: 'Design Tic-Tac-Toe', url: 'https://leetcode.com/problems/design-tic-tac-toe', difficulty: 'Medium', pattern: 'Design', companies: ['Meta'], frequency: '🔥🔥', category: 'Design' },
  { id: 'de-6', name: 'Time Based Key-Value Store', url: 'https://leetcode.com/problems/time-based-key-value-store', difficulty: 'Medium', pattern: 'Hash + Binary Search', companies: ['OpenAI', 'Databricks', 'Anthropic'], frequency: '🔥🔥', category: 'Design' },
  { id: 'de-7', name: 'Snapshot Array', url: 'https://leetcode.com/problems/snapshot-array', difficulty: 'Medium', pattern: 'Hash + Binary Search', companies: ['OpenAI', 'Databricks'], frequency: '🔥🔥', category: 'Design' },
  { id: 'de-8', name: 'Dot Product of Two Sparse Vectors', url: 'https://leetcode.com/problems/dot-product-of-two-sparse-vectors', difficulty: 'Medium', pattern: 'Hash Map', companies: ['Meta'], frequency: '🔥🔥🔥', category: 'Design' },
  { id: 'de-9', name: 'Design In-Memory File System', url: 'https://leetcode.com/problems/design-in-memory-file-system', difficulty: 'Hard', pattern: 'Trie/Tree', companies: ['Amazon', 'Google'], frequency: '🔥🔥', category: 'Design' },
  { id: 'de-10', name: 'Design Search Autocomplete System', url: 'https://leetcode.com/problems/design-search-autocomplete-system', difficulty: 'Hard', pattern: 'Trie + Heap', companies: ['Amazon'], frequency: '🔥🔥', category: 'Design' },
  { id: 'de-11', name: 'Max Stack', url: 'https://leetcode.com/problems/max-stack', difficulty: 'Hard', pattern: 'Stack + Tree', companies: ['LinkedIn', 'Databricks'], frequency: '🔥🔥', category: 'Design' },
  { id: 'de-12', name: 'All O\'one Data Structure', url: 'https://leetcode.com/problems/all-oone-data-structure', difficulty: 'Hard', pattern: 'Hash + DLL', companies: ['LinkedIn', 'Databricks'], frequency: '🔥', category: 'Design' },
  { id: 'de-13', name: 'Nested List Weight Sum', url: 'https://leetcode.com/problems/nested-list-weight-sum', difficulty: 'Medium', pattern: 'DFS', companies: ['Meta', 'LinkedIn'], frequency: '🔥🔥', category: 'Design' },
  { id: 'de-14', name: 'Nested List Weight Sum II', url: 'https://leetcode.com/problems/nested-list-weight-sum-ii', difficulty: 'Medium', pattern: 'DFS', companies: ['LinkedIn'], frequency: '🔥', category: 'Design' },
  { id: 'de-15', name: 'Design HashMap', url: 'https://leetcode.com/problems/design-hashmap', difficulty: 'Easy', pattern: 'Design', companies: ['Tesla'], frequency: '🔥', category: 'Design' },
  { id: 'de-16', name: 'Design Underground System', url: 'https://leetcode.com/problems/design-underground-system', difficulty: 'Medium', pattern: 'Design', companies: ['Tesla'], frequency: '🔥', category: 'Design' },
  { id: 'de-17', name: 'Web Crawler Multithreaded', url: 'https://leetcode.com/problems/web-crawler-multithreaded', difficulty: 'Medium', pattern: 'BFS + Threads', companies: ['OpenAI', 'Anthropic'], frequency: '🔥🔥', category: 'Design' },
  { id: 'de-18', name: 'Random Pick with Weight', url: 'https://leetcode.com/problems/random-pick-with-weight', difficulty: 'Medium', pattern: 'Prefix Sum + Binary Search', companies: ['Meta'], frequency: '🔥🔥', category: 'Design' },
  ...
  { id: 'uf-3', name: 'Redundant Connection', url: 'https://leetcode.com/problems/redundant-connection', difficulty: 'Medium', pattern: 'Union-Find', companies: ['Google'], frequency: '🔥🔥', category: 'Union-Find' },
  { id: 'uf-4', name: 'Make Network Connected', url: 'https://leetcode.com/problems/number-of-operations-to-make-network-connected', difficulty: 'Medium', pattern: 'Union-Find', companies: ['Meta', 'Amazon'], frequency: '🔥', category: 'Union-Find' },
  { id: 'uf-5', name: 'Regions Cut by Slashes', url: 'https://leetcode.com/problems/regions-cut-by-slashes', difficulty: 'Medium', pattern: 'Union-Find', companies: ['Google'], frequency: '🔥', category: 'Union-Find' },

  // ========================================
  // Additional Graph Patterns (11 questions)
  // ========================================
  { id: 'agp-1', name: 'Open the Lock', url: 'https://leetcode.com/problems/open-the-lock', difficulty: 'Medium', pattern: 'BFS', companies: ['Google', 'Amazon'], frequency: '🔥🔥', category: 'Graphs' },
  { id: 'agp-2', name: 'Path with Minimum Effort', url: 'https://leetcode.com/problems/path-with-minimum-effort', difficulty: 'Medium', pattern: 'Dijkstra/Binary Search', companies: ['Google', 'Amazon'], frequency: '🔥🔥', category: 'Graphs' },
  { id: 'agp-3', name: 'Swim in Rising Water', url: 'https://leetcode.com/problems/swim-in-rising-water', difficulty: 'Hard', pattern: 'Binary Search + BFS', companies: ['Google'], frequency: '🔥', category: 'Graphs' },
  { id: 'agp-4', name: 'The Maze', url: 'https://leetcode.com/problems/the-maze', difficulty: 'Medium', pattern: 'BFS/DFS', companies: ['Google', 'Meta'], frequency: '🔥🔥', category: 'Graphs' },
  { id: 'agp-5', name: 'The Maze II', url: 'https://leetcode.com/problems/the-maze-ii', difficulty: 'Medium', pattern: 'Dijkstra', companies: ['Google'], frequency: '🔥', category: 'Graphs' },
  { id: 'agp-6', name: 'The Maze III', url: 'https://leetcode.com/problems/the-maze-iii', difficulty: 'Hard', pattern: 'Dijkstra', companies: ['Google'], frequency: '🔥', category: 'Graphs' },
  { id: 'agp-7', name: 'Word Ladder II', url: 'https://leetcode.com/problems/word-ladder-ii', difficulty: 'Hard', pattern: 'BFS + Backtracking', companies: ['Google', 'Amazon'], frequency: '🔥🔥', category: 'Graphs' },

  // ========================================
  // Additional Backtracking (5 questions)
  // ========================================
  { id: 'abt-1', name: 'Combinations', url: 'https://leetcode.com/problems/combinations', difficulty: 'Medium', pattern: 'Backtracking', companies: ['Meta', 'Apple', 'Google'], frequency: '🔥🔥', category: 'Backtracking' },
  { id: 'abt-2', name: 'Combination Sum II', url: 'https://leetcode.com/problems/combination-sum-ii', difficulty: 'Medium', pattern: 'Backtracking', companies: ['Google'], frequency: '🔥🔥', category: 'Backtracking' },
  { id: 'abt-3', name: 'Subsets II', url: 'https://leetcode.com/problems/subsets-ii', difficulty: 'Medium', pattern: 'Backtracking', companies: ['Google', 'Amazon'], frequency: '🔥🔥', category: 'Backtracking' },
  { id: 'abt-4', name: 'Target Sum', url: 'https://leetcode.com/problems/target-sum', difficulty: 'Medium', pattern: 'DP/Backtracking', companies: ['Google', 'Meta'], frequency: '🔥🔥', category: 'Backtracking' },
  { id: 'abt-5', name: 'Smallest Sufficient Team', url: 'https://leetcode.com/problems/smallest-sufficient-team', difficulty: 'Hard', pattern: 'Bitmask DP', companies: ['Google'], frequency: '🔥', category: 'Backtracking' },

  // ========================================
  // Additional Heap (3 questions)
  // ========================================
  { id: 'ahp-1', name: 'Kth Largest Element in a Stream', url: 'https://leetcode.com/problems/kth-largest-element-in-a-stream', difficulty: 'Easy', pattern: 'Min Heap', companies: ['Amazon', 'Google', 'Netflix'], frequency: '🔥🔥', category: 'Heap / Priority Queue' },
  { id: 'ahp-2', name: 'Sliding Window Median', url: 'https://leetcode.com/problems/sliding-window-median', difficulty: 'Hard', pattern: 'Two Heaps', companies: ['Bloomberg', 'Google', 'Stripe'], frequency: '🔥🔥', category: 'Heap / Priority Queue' },

  // ========================================
  // Additional Stack (5 questions)
  // ========================================
  { id: 'ast-1', name: 'Implement Queue using Stacks', url: 'https://leetcode.com/problems/implement-queue-using-stacks', difficulty: 'Easy', pattern: 'Stack', companies: ['Amazon', 'Apple'], frequency: '🔥🔥', category: 'Stack / Monotonic Stack' },
  { id: 'ast-2', name: 'Implement Stack using Queues', url: 'https://leetcode.com/problems/implement-stack-using-queues', difficulty: 'Easy', pattern: 'Queue', companies: ['Amazon', 'Apple'], frequency: '🔥', category: 'Stack / Monotonic Stack' },
  { id: 'ast-3', name: 'Min Stack', url: 'https://leetcode.com/problems/min-stack', difficulty: 'Medium', pattern: 'Stack', companies: ['Amazon', 'Microsoft', 'Flipkart'], frequency: '🔥🔥', category: 'Stack / Monotonic Stack' },
  { id: 'ast-4', name: 'Minimum Insertions to Balance a String', url: 'https://leetcode.com/problems/minimum-insertions-to-balance-a-parentheses-string', difficulty: 'Medium', pattern: 'Stack', companies: ['Google'], frequency: '🔥', category: 'Stack / Monotonic Stack' },

  // ========================================
  // Additional Linked List (3 questions)
  // ========================================
  { id: 'all-1', name: 'Linked List Cycle II', url: 'https://leetcode.com/problems/linked-list-cycle-ii', difficulty: 'Medium', pattern: 'Floyd\'s Cycle', companies: ['Google', 'Amazon'], frequency: '🔥🔥', category: 'Linked List' },
  { id: 'all-2', name: 'Middle of the Linked List', url: 'https://leetcode.com/problems/middle-of-the-linked-list', difficulty: 'Easy', pattern: 'Fast/Slow', companies: ['Amazon'], frequency: '🔥🔥', category: 'Linked List' },
  { id: 'all-3', name: 'Palindrome Linked List', url: 'https://leetcode.com/problems/palindrome-linked-list', difficulty: 'Easy', pattern: 'Fast/Slow + Reverse', companies: ['Meta', 'Amazon'], frequency: '🔥🔥', category: 'Linked List' },

  // ========================================
  // Additional Array/String (11 questions)
  // ========================================
  { id: 'aas-1', name: 'Remove Duplicates from Sorted Array', url: 'https://leetcode.com/problems/remove-duplicates-from-sorted-array', difficulty: 'Easy', pattern: 'Two Pointers', companies: ['Google', 'Meta'], frequency: '🔥🔥', category: 'Two Pointers' },
  { id: 'aas-2', name: 'Find All Numbers Disappeared in an Array', url: 'https://leetcode.com/problems/find-all-numbers-disappeared-in-an-array', difficulty: 'Easy', pattern: 'Cyclic Sort', companies: ['Google'], frequency: '🔥', category: 'Arrays & Strings' },
  { id: 'aas-3', name: 'Ransom Note', url: 'https://leetcode.com/problems/ransom-note', difficulty: 'Easy', pattern: 'Hash Map', companies: ['Google'], frequency: '🔥', category: 'Arrays & Strings' },
  { id: 'aas-4', name: 'First Unique Character in a String', url: 'https://leetcode.com/problems/first-unique-character-in-a-string', difficulty: 'Easy', pattern: 'Hash Map', companies: ['Amazon', 'Adobe'], frequency: '🔥🔥', category: 'Arrays & Strings' },
  { id: 'aas-5', name: 'Reverse String', url: 'https://leetcode.com/problems/reverse-string', difficulty: 'Easy', pattern: 'Two Pointers', companies: ['Amazon'], frequency: '🔥', category: 'Two Pointers' },
  { id: 'aas-6', name: '4Sum', url: 'https://leetcode.com/problems/4sum', difficulty: 'Medium', pattern: 'Two Pointers', companies: ['Facebook', 'Adobe', 'Microsoft'], frequency: '🔥', category: 'Two Pointers' },
  { id: 'aas-7', name: 'Max Number of Vowels in Substring', url: 'https://leetcode.com/problems/maximum-number-of-vowels-in-a-substring-of-given-length', difficulty: 'Medium', pattern: 'Sliding Window', companies: ['Google'], frequency: '🔥', category: 'Sliding Window' },
  { id: 'aas-8', name: 'Smallest Divisor Given Threshold', url: 'https://leetcode.com/problems/find-the-smallest-divisor-given-a-threshold', difficulty: 'Medium', pattern: 'Binary Search on Answer', companies: ['Google', 'Uber', 'Amazon'], frequency: '🔥', category: 'Binary Search' },

  // ========================================
  // Additional HashMap/Frequency (3 questions)
  // ========================================
  { id: 'ahm-1', name: 'Top K Frequent Words', url: 'https://leetcode.com/problems/top-k-frequent-words', difficulty: 'Medium', pattern: 'Heap + HashMap', companies: ['Amazon', 'Google'], frequency: '🔥🔥', category: 'Hash Map / Set' },
  { id: 'ahm-2', name: 'Find First and Last Position of Element', url: 'https://leetcode.com/problems/find-first-and-last-position-of-element-in-sorted-array', difficulty: 'Medium', pattern: 'Binary Search', companies: ['Google', 'Meta'], frequency: '🔥🔥', category: 'Binary Search' },

  // ========================================
  // Additional Advanced Strings (8 questions)
  // ========================================
  { id: 'astr-1', name: 'Longest Substring with At Most Two Distinct Characters', url: 'https://leetcode.com/problems/longest-substring-with-at-most-two-distinct-characters', difficulty: 'Medium', pattern: 'Sliding Window', companies: ['Google', 'Atlassian'], frequency: '🔥🔥', category: 'Sliding Window' },
  { id: 'astr-2', name: 'Reverse Words in a String', url: 'https://leetcode.com/problems/reverse-words-in-a-string', difficulty: 'Medium', pattern: 'String', companies: ['Amazon', 'Adobe'], frequency: '🔥🔥', category: 'Arrays & Strings' },
  { id: 'astr-3', name: 'Zigzag Conversion', url: 'https://leetcode.com/problems/zigzag-conversion', difficulty: 'Medium', pattern: 'String', companies: ['Google'], frequency: '🔥', category: 'Arrays & Strings' },
  { id: 'astr-4', name: 'Repeated Substring Pattern', url: 'https://leetcode.com/problems/repeated-substring-pattern', difficulty: 'Easy', pattern: 'KMP/String', companies: ['Google'], frequency: '🔥', category: 'Arrays & Strings' },
  { id: 'astr-5', name: 'Minimum Remove to Make Valid Parentheses', url: 'https://leetcode.com/problems/minimum-remove-to-make-valid-parentheses', difficulty: 'Medium', pattern: 'Stack/Two-Pass', companies: ['Meta', 'Apple', 'Microsoft'], frequency: '🔥🔥🔥', category: 'Stack / Monotonic Stack' },

  // ========================================
  // Additional Trie (3 questions)
  // ========================================
  { id: 'atr-1', name: 'Replace Words', url: 'https://leetcode.com/problems/replace-words', difficulty: 'Medium', pattern: 'Trie', companies: ['Google', 'Amazon'], frequency: '🔥', category: 'Trie' },
  { id: 'atr-2', name: 'Longest Word in Dictionary', url: 'https://leetcode.com/problems/longest-word-in-dictionary', difficulty: 'Medium', pattern: 'Trie', companies: ['Google'], frequency: '🔥', category: 'Trie' },
  { id: 'atr-3', name: 'Map Sum Pairs', url: 'https://leetcode.com/problems/map-sum-pairs', difficulty: 'Medium', pattern: 'Trie', companies: ['Google'], frequency: '🔥', category: 'Trie' },

  // ========================================
  // Additional Segment Tree (4 questions)
  // ========================================
  { id: 'seg-1', name: 'Range Sum Query - Mutable', url: 'https://leetcode.com/problems/range-sum-query-mutable', difficulty: 'Medium', pattern: 'Segment Tree/BIT', companies: ['Amazon', 'Google'], frequency: '🔥🔥', category: 'Design' },
  { id: 'seg-2', name: 'My Calendar III', url: 'https://leetcode.com/problems/my-calendar-iii', difficulty: 'Hard', pattern: 'Segment Tree', companies: ['Google'], frequency: '🔥', category: 'Design' },
  { id: 'seg-3', name: 'Count of Smaller Numbers After Self', url: 'https://leetcode.com/problems/count-of-smaller-numbers-after-self', difficulty: 'Hard', pattern: 'Segment Tree/BIT', companies: ['Google', 'Amazon'], frequency: '🔥🔥', category: 'Design' },
  { id: 'seg-4', name: 'Shortest Subarray with Sum at Least K', url: 'https://leetcode.com/problems/shortest-subarray-with-sum-at-least-k', difficulty: 'Hard', pattern: 'Monotonic Deque', companies: ['Google'], frequency: '🔥', category: 'Stack / Monotonic Stack' },

  // ========================================
  // Additional Matrix & Simulation (6 questions)
  // ========================================
  { id: 'amx-1', name: 'Spiral Matrix II', url: 'https://leetcode.com/problems/spiral-matrix-ii', difficulty: 'Medium', pattern: 'Simulation', companies: ['Google'], frequency: '🔥', category: 'Matrix' },
  { id: 'amx-2', name: 'Transpose Matrix', url: 'https://leetcode.com/problems/transpose-matrix', difficulty: 'Easy', pattern: 'Matrix', companies: ['Google'], frequency: '🔥', category: 'Matrix' },
  { id: 'amx-3', name: 'Rectangle Area', url: 'https://leetcode.com/problems/rectangle-area', difficulty: 'Medium', pattern: 'Geometry', companies: ['Google'], frequency: '🔥', category: 'Matrix' },
  { id: 'amx-4', name: 'Valid Square', url: 'https://leetcode.com/problems/valid-square', difficulty: 'Medium', pattern: 'Geometry', companies: ['Google'], frequency: '🔥', category: 'Matrix' },
  { id: 'amx-5', name: 'Rotate Array', url: 'https://leetcode.com/problems/rotate-array', difficulty: 'Medium', pattern: 'Array', companies: ['Google'], frequency: '🔥🔥', category: 'Arrays & Strings' },
  { id: 'amx-6', name: 'Robot Bounded in Circle', url: 'https://leetcode.com/problems/robot-bounded-in-circle', difficulty: 'Medium', pattern: 'Simulation', companies: ['Google', 'Amazon'], frequency: '🔥🔥', category: 'Matrix' },

  // ========================================
  // Additional Design Patterns (8 questions)
  // ========================================
  { id: 'ade-1', name: 'Basic Calculator', url: 'https://leetcode.com/problems/basic-calculator', difficulty: 'Hard', pattern: 'Stack', companies: ['Google', 'Dropbox'], frequency: '🔥🔥', category: 'Stack / Monotonic Stack' },
  { id: 'ade-2', name: 'Data Stream as Disjoint Intervals', url: 'https://leetcode.com/problems/data-stream-as-disjoint-intervals', difficulty: 'Hard', pattern: 'TreeMap/BST', companies: ['Google'], frequency: '🔥', category: 'Design' },
  { id: 'ade-3', name: 'Logger Rate Limiter', url: 'https://leetcode.com/problems/logger-rate-limiter', difficulty: 'Easy', pattern: 'Hash Map', companies: ['Google', 'Amazon'], frequency: '🔥🔥', category: 'Design' },
  { id: 'ade-4', name: 'Design Snake Game', url: 'https://leetcode.com/problems/design-snake-game', difficulty: 'Medium', pattern: 'Design/Deque', companies: ['Google', 'Amazon'], frequency: '🔥', category: 'Design' },
  { id: 'ade-5', name: 'Find Winner on a Tic Tac Toe Game', url: 'https://leetcode.com/problems/find-winner-on-a-tic-tac-toe-game', difficulty: 'Easy', pattern: 'Simulation', companies: ['Google'], frequency: '🔥', category: 'Design' },
  { id: 'ade-6', name: 'Design Twitter', url: 'https://leetcode.com/problems/design-twitter', difficulty: 'Medium', pattern: 'Heap/Graph', companies: ['Google', 'Meta'], frequency: '🔥🔥', category: 'Design' },
  { id: 'ade-7', name: 'Rearrange String K Distance Apart', url: 'https://leetcode.com/problems/rearrange-string-k-distance-apart', difficulty: 'Hard', pattern: 'Heap + Greedy', companies: ['Google', 'Amazon'], frequency: '🔥🔥', category: 'Heap / Priority Queue' },
  { id: 'ade-8', name: 'Smallest String With Swaps', url: 'https://leetcode.com/problems/smallest-string-with-swaps', difficulty: 'Medium', pattern: 'Union-Find', companies: ['Google', 'Dropbox'], frequency: '🔥', category: 'Union-Find' },

  // ========================================
  // Additional Bit Manipulation (4 questions)
  // ========================================
  { id: 'abit-1', name: 'Single Number II', url: 'https://leetcode.com/problems/single-number-ii', difficulty: 'Medium', pattern: 'Bit Manipulation', companies: ['Google'], frequency: '🔥', category: 'Math / Bit Manipulation' },
  { id: 'abit-2', name: 'Single Number III', url: 'https://leetcode.com/problems/single-number-iii', difficulty: 'Medium', pattern: 'Bit Manipulation', companies: ['Google', 'Meta'], frequency: '🔥', category: 'Math / Bit Manipulation' },
  { id: 'abit-3', name: 'Bitwise AND of Numbers Range', url: 'https://leetcode.com/problems/bitwise-and-of-numbers-range', difficulty: 'Medium', pattern: 'Bit Manipulation', companies: ['Google'], frequency: '🔥', category: 'Math / Bit Manipulation' },
  { id: 'abit-4', name: 'Maximum XOR of Two Numbers', url: 'https://leetcode.com/problems/maximum-xor-of-two-numbers-in-an-array', difficulty: 'Medium', pattern: 'Binary Trie', companies: ['Google', 'Nvidia', 'Qualcomm'], frequency: '🔥🔥', category: 'Math / Bit Manipulation' },

  // ========================================
  // Additional Math (7 questions)
  // ========================================
  { id: 'amt-1', name: 'Max Points on a Line', url: 'https://leetcode.com/problems/max-points-on-a-line', difficulty: 'Hard', pattern: 'Math/GCD', companies: ['Google', 'Meta'], frequency: '🔥🔥', category: 'Math / Bit Manipulation' },
  { id: 'amt-2', name: 'Count Primes', url: 'https://leetcode.com/problems/count-primes', difficulty: 'Medium', pattern: 'Sieve', companies: ['Google'], frequency: '🔥', category: 'Math / Bit Manipulation' },
  { id: 'amt-3', name: 'Super Pow', url: 'https://leetcode.com/problems/super-pow', difficulty: 'Medium', pattern: 'Binary Exponentiation', companies: ['Google'], frequency: '🔥', category: 'Math / Bit Manipulation' },
  { id: 'amt-4', name: 'Pascal\'s Triangle', url: 'https://leetcode.com/problems/pascals-triangle', difficulty: 'Easy', pattern: 'Math/DP', companies: ['Google'], frequency: '🔥', category: 'Math / Bit Manipulation' },
  { id: 'amt-5', name: 'Pascal\'s Triangle II', url: 'https://leetcode.com/problems/pascals-triangle-ii', difficulty: 'Easy', pattern: 'Math/DP', companies: ['Google'], frequency: '🔥', category: 'Math / Bit Manipulation' },

  // ========================================
  // Additional Greedy (3 questions)
  // ========================================
  { id: 'agy-1', name: 'Jump Game IV', url: 'https://leetcode.com/problems/jump-game-iv', difficulty: 'Hard', pattern: 'BFS', companies: ['Google', 'Amazon'], frequency: '🔥', category: 'Graphs' },
  { id: 'agy-2', name: 'Maximum Sum Circular Subarray', url: 'https://leetcode.com/problems/maximum-sum-circular-subarray', difficulty: 'Medium', pattern: 'Kadane\'s Variant', companies: ['Amazon'], frequency: '🔥🔥', category: 'Arrays & Strings' },
  { id: 'agy-3', name: 'Online Stock Span', url: 'https://leetcode.com/problems/online-stock-span', difficulty: 'Medium', pattern: 'Monotonic Stack', companies: ['Amazon', 'Google'], frequency: '🔥🔥', category: 'Stack / Monotonic Stack' },
];
