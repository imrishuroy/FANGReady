      ...
      {pattern.tutorial!.map((section, idx) => (
        <article key={idx} className="scroll-mt-24" id={`section-${idx}`}>
          ...
          <div className="flex items-baseline gap-3 mb-6">
            <span className="text-indigo-400 font-mono text-lg">{idx + 1}.</span>
          ...
          <div className="pl-7">
            <div className="tutorial-content">
              <ReactMarkdown
                ...
                components={{
                  ...
                  h3: ({ children }) => (
                    <h5 className="text-lg font-semibold text-indigo-400 mt-5 mb-2">{children}</h5>
                  ),
                  ul: ({ children }) => (
                    <ul className="space-y-2 my-4">{children}</ul>
                  ),
                  ol: ({ children }) => (
                    <ol className="space-y-2 my-4 counter-reset-item">{children}</ol>
                  ),
                  li: ({ children, ...props }) => {
                    const isOrdered = props.node?.position &&
                  ...
                  code: ({ className, children, ...props }) => {
                    ...
                    if (isBlock || (props.node?.position?.start.line !== props.node?.position?.end.line)) {
                          ...
                          <div className="p-4 overflow-x-auto">
                            {lines.map((line, i) => (
                              <div key={i} className="leading-relaxed">
                                <span className={`text-sm font-mono whitespace-pre ${
                                  line.includes('←') || line.includes('Answer') || line.includes('✓')
                                    ? 'text-green-400 font-medium'
                                    : line.startsWith('Array:') || line.startsWith('Prefix') || line.startsWith('String:')
                                    ? 'text-indigo-400'
                                    : line.startsWith('Step') || line.startsWith('i=')
                                    ? 'text-gray-300'
                                    : line.includes('Maximum') || line.includes('Final') || line.includes('Result')
                                    ? 'text-yellow-400'
                                    : line.includes('|')
                                    ? 'text-gray-400'
                                    : 'text-gray-400'
                  ...
                  thead: ({ children }) => (
                    <thead className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border-b border-gray-700">{children}</thead>
                  ),
                  tbody: ({ children }) => (
            ...
            {pattern.category === 'Dynamic Programming' && section.title.includes('Decision Trees') && (
              <div className="mt-8">
            ...
            {pattern.category === 'Dynamic Programming' && section.title.includes('Deriving Recurrence') && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Dynamic Programming' && section.title.includes('Complete DP Transformation') && (
            ...
            {pattern.category === 'Dynamic Programming' && section.title.includes('2D DP') && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Dynamic Programming' && section.title.includes('Knapsack') && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
                  <span className="text-orange-400">▶</span> Interactive Knapsack
                </h4>
                <KnapsackVisualizer />
              </div>
            )}
            ...
            {/* Greedy Visualizers */}
            {pattern.category === 'Greedy' && (section.title.includes('Activity') || section.title.includes('Interval') || section.title.includes('Scheduling')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Greedy' && (section.title.includes('Jump') || section.title.includes('Reachability') || section.title.includes('Array Traversal')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {/* Graph Visualizers */}
            {pattern.category === 'Graphs' && (section.title.includes('Grid') || section.title.includes('Islands') || section.title.includes('DFS vs BFS')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Graphs' && (section.title.includes('Topological') || section.title.includes('Course')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Graphs' && (section.title.includes('Dijkstra') || section.title.includes('Weighted')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Hash Map / Set' && (section.title.includes('Two Sum') || section.title.includes('Complement')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Hash Map / Set' && (section.title.includes('Grouping') || section.title.includes('Anagram')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Hash Map / Set' && (section.title.includes('Consecutive') || section.title.includes('Sequence')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Heap / Priority Queue' && (section.title.includes('Kth') || section.title.includes('K Largest') || section.title.includes('Top K')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Heap / Priority Queue' && (section.title.includes('Two Heaps') || section.title.includes('Median')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Heap / Priority Queue' && (section.title.includes('Merge K') || section.title.includes('Merging')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Intervals' && (section.title.includes('Merge') && !section.title.includes('K')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Intervals' && (section.title.includes('Meeting') || section.title.includes('Line Sweep')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Intervals' && (section.title.includes('Intersection')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Linked List' && (section.title.includes('Reversal') || section.title.includes('Reverse') && !section.title.includes('k-Group')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Linked List' && (section.title.includes('Fast/Slow') || section.title.includes('Floyd') || section.title.includes('Cycle')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Linked List' && (section.title.includes('Reorder') || section.title.includes('Combining')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Prefix Sum' && (section.title.includes('Building') || section.title.includes('Querying') || section.title.includes('What is')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Prefix Sum' && (section.title.includes('Subarray Sum') || section.title.includes('HashMap')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Prefix Sum' && (section.title.includes('Product') || section.title.includes('Except Self')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Sliding Window' && (section.title.includes('Fixed') || section.title.includes('Maximum Sum')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Sliding Window' && (section.title.includes('Longest Substring') || section.title.includes('Without Repeating')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Sliding Window' && (section.title.includes('Anagram') || section.title.includes('Frequency Counter')) && (
              <div className="mt-8">
                <h4 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
            ...
            {pattern.category === 'Stack / Monotonic Stack' && section.title.includes('Interactive') && section.title.includes('Valid Parentheses') && (
              <div className="mt-8">
                <ValidParenthesesVisualizer />
              </div>
            )}

            {pattern.category === 'Stack / Monotonic Stack' && section.title.includes('Interactive') && section.title.includes('Next Greater') && (
              <div className="mt-8">
                <NextGreaterVisualizer />
              </div>
            )}

            {pattern.category === 'Stack / Monotonic Stack' && section.title.includes('Interactive') && section.title.includes('Largest Rectangle') && (
              <div className="mt-8">
            ...
            {/* Trees Visualizers */}
            {pattern.category === 'Trees' && section.title.includes('Interactive') && section.title.includes('DFS') && (
              <div className="mt-8">
                <TreeTraversalVisualizer />
              </div>
            )}

            {pattern.category === 'Trees' && section.title.includes('Interactive') && section.title.includes('Level Order') && (
              <div className="mt-8">
                <LevelOrderVisualizer />
              </div>
            )}

            {pattern.category === 'Trees' && section.title.includes('Interactive') && section.title.includes('BST') && (
              <div className="mt-8">
            ...
            {/* Trie Visualizers */}
            {pattern.category === 'Trie' && section.title.includes('Interactive') && section.title.includes('Insert') && (
              <div className="mt-8">
                <TrieInsertVisualizer />
              </div>
            )}

            {pattern.category === 'Trie' && section.title.includes('Interactive') && section.title.includes('Search') && (
              <div className="mt-8">
            ...
            {pattern.category === 'Two Pointers' && section.title.includes('Interactive') && section.title.includes('Two Sum') && (
              <div className="mt-8">
                <TwoSumSortedVisualizer />
              </div>
            )}

            {pattern.category === 'Two Pointers' && section.title.includes('Interactive') && section.title.includes('Container') && (
              <div className="mt-8">
                <ContainerWaterVisualizer />
              </div>
            )}

            {pattern.category === 'Two Pointers' && section.title.includes('Interactive') && section.title.includes('Remove Duplicates') && (
              <div className="mt-8">
            ...
            {pattern.category === 'Union-Find' && section.title.includes('Interactive') && section.title.includes('Union-Find') && (
              <div className="mt-8">
                <UnionFindVisualizer />
              </div>
            )}

            {pattern.category === 'Union-Find' && section.title.includes('Interactive') && section.title.includes('Connected Components') && (
              <div className="mt-8">
            ...
            {pattern.category === 'Arrays & Strings' && section.title.includes('Interactive') && section.title.includes('Two Sum') && (
              <div className="mt-8">
                <TwoSumHashMapVisualizer />
              </div>
            )}

            {pattern.category === 'Arrays & Strings' && section.title.includes('Interactive') && section.title.includes('Kadane') && (
              <div className="mt-8">
                <KadaneVisualizer />
              </div>
            )}

            {pattern.category === 'Arrays & Strings' && section.title.includes('Interactive') && section.title.includes('Prefix Sum') && (
              <div className="mt-8">
            ...
            {pattern.category === 'Backtracking' && section.title.includes('Interactive') && section.title.includes('Subsets') && (
              <div className="mt-8">
                <SubsetsVisualizer />
              </div>
            )}

            {pattern.category === 'Backtracking' && section.title.includes('Interactive') && section.title.includes('Permutations') && (
              <div className="mt-8">
                <PermutationsVisualizer />
              </div>
            )}

            {pattern.category === 'Backtracking' && section.title.includes('Interactive') && section.title.includes('N-Queens') && (
              <div className="mt-8">
                <NQueensVisualizer />
              </div>
            )}
            ...
            {pattern.category === 'Binary Search' && section.title.includes('Interactive') && section.title.includes('Binary Search Visualizer') && (
              <div className="mt-8">
                <BinarySearchVisualizer />
              </div>
            )}

            {pattern.category === 'Binary Search' && section.title.includes('Interactive') && section.title.includes('Rotated Array') && (
              <div className="mt-8">
                <RotatedArrayVisualizer />
              </div>
            )}

            {pattern.category === 'Binary Search' && section.title.includes('Interactive') && section.title.includes('Binary Search on Answer') && (
              <div className="mt-8">
